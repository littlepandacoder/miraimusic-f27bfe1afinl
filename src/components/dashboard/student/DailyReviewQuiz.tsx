...
const BANK: Q[] = [
  ...
  { level:1, category:"note_naming", question:"How many lines does a stave (staff) have?", options:["3","4","5","6"], correct:2, explanation:"A stave has 5 lines and 4 spaces between them." },
  { level:1, category:"note_naming", question:"What is a ledger line?", options:["A line that separates bars","A short line above or below the stave for notes outside its range","The top line of the stave","A line connecting two notes"], correct:1, explanation:"Ledger lines are short extra lines added above or below the stave to write notes outside its range." },
  { level:1, category:"note_naming", question:"What note is written on the first ledger line below the treble stave?", options:["B3","A3","Middle C (C4)","D4"], correct:2, explanation:"Middle C sits on its own ledger line just below the treble stave." },
  { level:1, category:"note_naming", question:"Which clef is used for higher-pitched instruments like violin and flute?", options:["Bass clef","Alto clef","Treble clef","Tenor clef"], correct:2, explanation:"The treble clef is used for higher-pitched instruments and the right hand on piano." },
  { level:1, category:"note_naming", question:"Which clef is used for lower-pitched instruments like cello and tuba?", options:["Treble clef","Bass clef","Alto clef","Soprano clef"], correct:1, explanation:"The bass clef is used for lower-pitched instruments and the left hand on piano." },
  { level:1, category:"note_naming", question:"In the treble clef, what note sits on the middle (3rd) line of the stave?", options:["C","D","B","E"], correct:2, explanation:"The middle (third) line of the treble stave is B4." },
  ...
  { level:1, category:"rhythm", question:"In 4/4 time, what does the bottom number '4' mean?", options:["There are 4 bars","A crotchet (quarter note) gets one beat","There are 4 beats per bar","The music is very fast"], correct:1, explanation:"The bottom number 4 represents the crotchet (quarter note) as the unit of the beat." },
  { level:1, category:"rhythm", question:"In 3/4 time, how many crotchet beats are in each bar?", options:["1","2","3","4"], correct:2, explanation:"3/4 time has 3 crotchet beats per bar — commonly used in waltzes." },
  { level:1, category:"rhythm", question:"In 2/4 time, how many crotchet beats are in each bar?", options:["1","2","3","4"], correct:1, explanation:"2/4 time has 2 crotchet beats per bar — a march-like feel." },
  { level:1, category:"rhythm", question:"What does a dot after a note do to its value?", options:["Doubles it","Halves it","Adds half its value to it","Takes away half its value"], correct:2, explanation:"A dot adds half the note's original value. A dotted minim = 2 + 1 = 3 beats." },
  { level:1, category:"rhythm", question:"What is a tie in music?", options:["A curved line connecting two notes of different pitch","A curved line connecting two notes of the same pitch, joining their durations","A type of slur mark","A repeat symbol"], correct:1, explanation:"A tie joins two notes of the same pitch, adding their time values together without re-striking." },
  { level:1, category:"rhythm", question:"How many semiquavers equal one minim?", options:["2","4","8","16"], correct:2, explanation:"Minim = 2 crotchets = 4 quavers = 8 semiquavers." },
  { level:1, category:"rhythm", question:"What is the British name for the note that receives one beat in 4/4 time?", options:["Quaver","Minim","Crotchet","Semibreve"], correct:2, explanation:"A crotchet (quarter note) typically gets one beat in 4/4, 3/4, and 2/4 time." },
  { level:1, category:"rhythm", question:"A semibreve rest looks like a rectangle hanging from a line. A minim rest sits on top of a line. How long does a semibreve rest last in 4/4?", options:["1 beat","2 beats","3 beats","A whole bar (4 beats)"], correct:3, explanation:"A semibreve rest fills an entire 4/4 bar — it rests for 4 beats." },
  ...
  { level:1, category:"theory", question:"What does 'mezzo-forte' (mf) mean?", options:["Very loud","Moderately loud","Very soft","Moderately soft"], correct:1, explanation:"Mezzo-forte (mf) means moderately loud — between piano and forte." },
  { level:1, category:"theory", question:"What does 'mezzo-piano' (mp) mean?", options:["Moderately soft","Moderately loud","Very soft","Very loud"], correct:0, explanation:"Mezzo-piano (mp) means moderately soft — slightly louder than piano." },
  { level:1, category:"theory", question:"What does 'pianissimo' (pp) mean?", options:["Loud","Moderately soft","Very soft","Very loud"], correct:2, explanation:"Pianissimo (pp) means very soft — softer than piano (p)." },
  { level:1, category:"theory", question:"What does 'fortissimo' (ff) mean?", options:["Very soft","Moderately loud","Loud","Very loud"], correct:3, explanation:"Fortissimo (ff) means very loud — louder than forte (f)." },
  { level:1, category:"theory", question:"What does a crescendo (< hairpin) tell the performer?", options:["Get softer gradually","Get louder gradually","Slow down","Speed up"], correct:1, explanation:"A crescendo tells you to gradually increase the volume." },
  { level:1, category:"theory", question:"What does a decrescendo/diminuendo (> hairpin) tell the performer?", options:["Get louder gradually","Speed up","Get softer gradually","Slow down"], correct:2, explanation:"A decrescendo (or diminuendo) tells you to gradually decrease the volume." },
  { level:1, category:"theory", question:"What does 'Andante' mean as a tempo marking?", options:["Very fast","Very slow","Walking pace (moderately slow)","Moderately fast"], correct:2, explanation:"Andante (Italian for 'walking') indicates a moderate, walking-pace tempo." },
  { level:1, category:"theory", question:"What does 'Allegro' mean as a tempo marking?", options:["Very slow","Slow","Walking pace","Fast and lively"], correct:3, explanation:"Allegro means fast and lively — one of the most common tempo markings." },
  { level:1, category:"theory", question:"What does 'Moderato' mean as a tempo marking?", options:["Very fast","Very slow","At a moderate speed","Walking pace"], correct:2, explanation:"Moderato means at a moderate speed — not too fast, not too slow." },
  { level:1, category:"theory", question:"What does 'Adagio' mean as a tempo marking?", options:["Fast","Moderately slow (slowly and stately)","Very fast","Moderate"], correct:1, explanation:"Adagio means slowly and stately — slower than Andante." },
  { level:1, category:"theory", question:"What does 'staccato' mean?", options:["Smooth and connected","Short and detached","Very loud","Getting faster"], correct:1, explanation:"Staccato (shown with a dot above/below the note) means play it short and detached." },
  { level:1, category:"theory", question:"What is a key signature?", options:["The speed of the music","Sharps or flats placed at the start of each stave to show the key","The time signature","The clef used"], correct:1, explanation:"A key signature shows which notes are permanently sharp or flat throughout the piece." },
  { level:1, category:"theory", question:"How many sharps does the key of G major have?", options:["0","1","2","3"], correct:1, explanation:"G major has one sharp: F#." },
  { level:1, category:"theory", question:"Which note is sharp in the key of G major?", options:["C#","G#","F#","B#"], correct:2, explanation:"In G major, every F is raised to F# to maintain the major scale pattern." },
  { level:1, category:"theory", question:"How many flats does the key of F major have?", options:["0","1","2","3"], correct:1, explanation:"F major has one flat: B♭." },
  { level:1, category:"theory", question:"Which note is flat in the key of F major?", options:["E♭","A♭","B♭","D♭"], correct:2, explanation:"In F major, every B is lowered to B♭ to maintain the major scale pattern." },
  { level:1, category:"theory", question:"What are the notes of the G major scale?", options:["G A B C D E F G","G A B C D E F# G","G A Bb C D E F G","G A B C# D E F# G"], correct:1, explanation:"G major has one sharp (F#): G A B C D E F# G." },
  { level:1, category:"theory", question:"What are the notes of the F major scale?", options:["F G A Bb C D E F","F G A B C D E F","F G Ab Bb C D E F","F G A Bb C Db E F"], correct:0, explanation:"F major has one flat (B♭): F G A B♭ C D E F." },
  { level:1, category:"theory", question:"What is C major's key signature?", options:["One sharp (F#)","One flat (B♭)","No sharps or flats","Two sharps"], correct:2, explanation:"C major has no sharps or flats — every note is a white key on the piano." },
  { level:1, category:"theory", question:"What is a semitone?", options:["Two piano keys apart (skipping one)","The smallest interval in Western music (one piano key apart)","Half a crotchet","A type of rest"], correct:1, explanation:"A semitone is the smallest interval — the distance between any two adjacent keys on the piano." },
  { level:1, category:"theory", question:"What is a tone (in music)?", options:["A single musical note","Two semitones","A type of scale","Half a semitone"], correct:1, explanation:"A tone = 2 semitones. On the piano, C to D is a tone (one white key apart, skipping C#/D♭)." },
  { level:1, category:"theory", question:"What does 'D.C.' (Da Capo) mean?", options:["Go back to the beginning","Go to the sign (𝄋)","End of the piece","Repeat the previous bar"], correct:0, explanation:"Da Capo (D.C.) means 'from the head' — go back to the very beginning of the piece." },
  { level:1, category:"theory", question:"What does a bar line do?", options:["Shows the key signature","Divides the music into bars (measures)","Marks the end of the piece","Indicates a repeat"], correct:1, explanation:"Bar lines are vertical lines across the stave that divide the music into equal bars." },
  { level:1, category:"theory", question:"What does a double bar line with two dots (repeat sign) mean?", options:["End of the piece","Slow down","Repeat the section between the dots","Skip the section"], correct:2, explanation:"A repeat sign tells the performer to play the enclosed section again from the beginning or the matching sign." },
